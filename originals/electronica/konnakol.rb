...
live_loop :vocal do
  ...
  use_random_seed 120
  with_fx :reverb, mix: 0.3, amp: 3do
  
  3.times do
    
    sample vocal, beat_stretch: 120, onset: [0,1,2,3,4,5,7,16,23].choose
    sleep 1
  end
  ...
  2.times do
    sample vocal, beat_stretch: 120, onset: 16, release: 0.01
    sleep 0.25
  end
...
live_loop :drum_loop do
  ##| stop
  1.times do
    sample "/Users/sangarshanan/Downloads/samples/drum_loops/dubstep/1.wav", beat_stretch: 30, finish: 0.5
    sleep 15
  end
end
